    ...
    protected void doInit() throws SensorHubException {
        ...
        connection = new RobustHTTPConnection(this, config.connection, "Axis Camera") {
           ...
           protected void prepareHttpConnection(HttpURLConnection conn) throws IOException
           {
            ...
            @Override
            protected void prepareHttpConnection(HttpURLConnection conn, String requestKey, String scheme, String requestValue) throws IOException
            {
                String username = config.http.user;
                String password = config.http.password;
                ...
                if (username != null && !username.isEmpty())
                {
                    ...
                    String authHeaderValue = "Basic " + encoded;
                    conn.setRequestProperty("Authorization", authHeaderValue);
                    conn.setRequestProperty(scheme + " " + requestKey , requestValue);
                }
            }
